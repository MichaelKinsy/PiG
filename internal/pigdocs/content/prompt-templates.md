> PiG can create prompt templates. Ask it to build one for your workflow.
...
PiG loads prompt templates from:

- Global: `~/.pig/agent/prompts/*.md`
- Project: `.pig/prompts/*.md` (only after the project is trusted)
