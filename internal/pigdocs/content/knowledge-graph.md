...
| PiG | The Go implementation; executable pig. | `coding/pigversion/pigversion.go pins Pi` | `pig verify` | [README.md](README.md) |
...
| Divergence | A numbered, approved, user-visible difference from pinned Pi. | `DIVERGENCES.md` | `pig docs show divergences` | [divergences.md](divergences.md) |
