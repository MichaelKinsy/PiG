...
- Fixed extension messages whose content is a list of blocks, such as `pi-web-access`'s `/websearch` results, showing as `[map[text:... type:text]]`. They now show their text blocks joined by newlines, as in Pi.
