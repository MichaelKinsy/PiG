...
| `packages/coding-agent/src/core/package-manager.ts` | ✅ | 6 (01-noninteractive-undecided-denies-project-extension, 02-no-approve-denies-project-extension, 03-approve-loads-project-extension, 05-package-list-empty, 06-package-list-git-source, 23-extension-directory-entries) | 6 (01-noninteractive-undecided-denies-project-extension, 02-no-approve-denies-project-extension, 03-approve-loads-project-extension, 05-package-list-empty, 06-package-list-git-source, 23-extension-directory-entries) | not run |  |
