...
| `packages/coding-agent/src/core/agent-session.ts` | ✅ | 27 (02-json-mode-extension-command, 02-print-extension-command, 02-session-memory-context, 04-overflow-retry, 05-nothing-to-compact-too-small, 05-session-info-after-tool-cycle, 06-overflow-retry-flushes-queued-message, 07-escape-cancels-compaction, 08-manual-compaction-flushes-entered-message, 08-print-faux-auto-retry, 08-session-info-populated-all-entries, 13-rpc-steering-queue, 14-rpc-bash-streaming, 15-rpc-compaction-result, 16-model-picker-enter-session-only, 17-at-file-literal-user-message, 17-model-picker-save-default, 17-rpc-abort-retry, 18-model-picker-save-default-scope-order, 18-rpc-session-replacement-cancel, 20-rpc-runtime-boundary-values, 21-extension-tool-and-command-info, 21-rpc-extension-session-events, 22-rpc-unknown-model-preflight, 23-rpc-multi-model-cycle-order, 24-rpc-prompt-during-compaction, 25-rpc-clear-queue) | 27 (02-json-mode-extension-command, 02-print-extension-command, 02-session-memory-context, 04-overflow-retry, 05-nothing-to-compact-too-small, 05-session-info-after-tool-cycle, 06-overflow-retry-flushes-queued-message, 07-escape-cancels-compaction, 08-manual-compaction-flushes-entered-message, 08-print-faux-auto-retry, 08-session-info-populated-all-entries, 13-rpc-steering-queue, 14-rpc-bash-streaming, 15-rpc-compaction-result, 16-model-picker-enter-session-only, 17-at-file-literal-user-message, 17-model-picker-save-default, 17-rpc-abort-retry, 18-model-picker-save-default-scope-order, 18-rpc-session-replacement-cancel, 20-rpc-runtime-boundary-values, 21-extension-tool-and-command-info, 21-rpc-extension-session-events, 22-rpc-unknown-model-preflight, 23-rpc-multi-model-cycle-order, 24-rpc-prompt-during-compaction, 25-rpc-clear-queue) | not run |  |
...
| `packages/coding-agent/src/core/resource-loader.ts` | ✅ | 10 (01-noninteractive-undecided-denies-project-extension, 02-no-approve-denies-project-extension, 03-approve-loads-project-extension, 04-project-cannot-set-its-own-trust-default, 05-global-always-default-loads-project-extension, 06-prompt-template-migration-expand, 06-session-cwd-precedes-project-resource-loading, 07-resume-picker-selects-cwd-before-resources, 07-skill-command-system-prompt, 08-global-extension-decides-project-trust) | 10 (01-noninteractive-undecided-denies-project-extension, 02-no-approve-denies-project-extension, 03-approve-loads-project-extension, 04-project-cannot-set-its-own-trust-default, 05-global-always-default-loads-project-extension, 06-prompt-template-migration-expand, 06-session-cwd-precedes-project-resource-loading, 07-resume-picker-selects-cwd-before-resources, 07-skill-command-system-prompt, 08-global-extension-decides-project-trust) | not run |  |
...
| `packages/coding-agent/src/core/source-info.ts` | ✅ | 2 (02-config-resources-list, 21-extension-tool-and-command-info) | 2 (02-config-resources-list, 21-extension-tool-and-command-info) | not run |  |
...
| `packages/coding-agent/src/core/extensions/types.ts` | 🟡 | 6 (01-print-extension-tool-bridge, 01-register-handshake, 03-tool-call-blocker, 16-rpc-extension-ui-events, 19-rpc-extension-ui-select, 21-extension-tool-and-command-info) | 6 (01-print-extension-tool-bridge, 01-register-handshake, 03-tool-call-blocker, 16-rpc-extension-ui-events, 19-rpc-extension-ui-select, 21-extension-tool-and-command-info) | not run |  |
...
| `packages/coding-agent/src/modes/interactive/components/tool-execution.ts` | ✅ | 3 (03-tool-execution-bash, 04-conversation-layout, 19-generic-tool-details) | 3 (03-tool-execution-bash, 04-conversation-layout, 19-generic-tool-details) | not run |  |
...
| `packages/tui/src/autocomplete.ts` | ✅ | 7 (01-slash-popup, 02-slash-filter-model, 03-slash-accept-hotkeys, 04-slash-dismiss, 05-path-force-tab-popup, 06-path-accept-partial, 07-path-dismiss) | 7 (01-slash-popup, 02-slash-filter-model, 03-slash-accept-hotkeys, 04-slash-dismiss, 05-path-force-tab-popup, 06-path-accept-partial, 07-path-dismiss) | not run |  |
...
| `packages/tui/src/components/editor.ts` | ✅ | 3 (02-slash-filter-model, 06-settings-editor-padding-live, 12-editor-wrapped-history-navigation) | 3 (02-slash-filter-model, 06-settings-editor-padding-live, 12-editor-wrapped-history-navigation) | not run |  |
