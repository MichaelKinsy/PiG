...
//go:embed runtime-node/*.mjs runtime-node/shims/*.mjs runtime-node/shims/get-east-asian-width runtime-node/shims/partial-json runtime-node/shims/pi-dist runtime-node/shims/yaml
